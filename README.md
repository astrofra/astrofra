...
- 2014, _ColorCycler_, created with [Douglas Alves](https://twitter.com/_Adoru_) and [Florian Dufour](https://albatr.itch.io/)
...
Starting with basic modeling for real-time 3D, I developed a [personal writing style](https://astrofra.cgsociety.org/94ee/demoreel-2004-slash-) using global illumination, which was just becoming available in Lightwave 3D and added texture to 3D rendering.
